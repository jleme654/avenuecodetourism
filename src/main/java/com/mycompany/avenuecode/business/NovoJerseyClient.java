...
/**
 * Jersey REST client generated for REST resource:ContinentFacadeREST
 * [continents]<br>
 * USAGE:
 * <pre>
 *        NovoJerseyClient client = new NovoJerseyClient();
 ...
 * @author Julio Leme
 */
public class NovoJerseyClient {

    private WebResource webResource;
    private Client client;
    private static final String BASE_URI = "http://localhost:8084/AvenueCode/recursos";

    public NovoJerseyClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("continents");
    }

    public NovoJerseyClient(String username, String password) {
        this();
